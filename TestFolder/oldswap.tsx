      ...
      <AppBody>
        ...
        <Wrapper id="swap-page">
          <ConfirmSwapModal
            ...
            txHash={txHash}
            recipient={recipient} // might have to change to account due to smart contract sending
            allowedSlippage={allowedSlippage}
            onConfirm={NewSwapTransaction} // was handleSwap now replaced
                ...
                <AutoRow style={{ flexWrap: 'nowrap', width: '100%' }}>
                  <AutoColumn style={{ width: '100%' }} gap="12px">
                      ...
                      <AutoRow justify="space-between" style={{ flexWrap: 'nowrap' }}>
                        ...
                        {approvalState === ApprovalState.PENDING ? (
                          ...
                          <MouseoverTooltip
                            text={
                              <Trans>
                                You must give the smart contract permission to use your{' '}
                    ...
                    <ButtonError
                      onClick={() => {
                        if (isExpertMode) {
                          NewSwapTransaction() ///handleSwap() - original
                        } else {
                          setSwapState({
