...
export function useSystemTheme() {
  ...
  const [systemTheme, setSystemTheme] = useState(prefersDark.matches ? darkTheme : newTheme)
  prefersDark.addEventListener('change', (e) => {
    setSystemTheme(e.matches ? darkTheme : newTheme)
  })
  return systemTheme
}
